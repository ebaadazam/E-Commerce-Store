    ...
    <div className="bg-white">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          <ol role="list" className="mx-auto flex max-w-5xl items-center justify-end space-x-2 px-4 sm:px-6 lg:max-w-4xl lg:px-8 ml-12 mr-3 mb-0">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <Box display="flex" justifyContent="center" alignItems="center" height="10vh">
                  <Button onClick={handleAddToCart} variant="contained" sx={{ color: 'fuchsia', color: 'white' }}>
                    Add to Cart
                  </Button>
                </Box>
          ...
          <div className="flex flex-col item-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              ...
              <div className='grid grid-cols-5 gap-x-4 mt-4'>
                {product.images.slice(0).map((item) => (
                  <img

                    src={item.src}
                    alt={item.alt}
                    className='rounded-lg h-32 object-cover object-center w-[30]'
                  />
                ))}
              </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-60'>53427 Ratings</p>
                </div>
